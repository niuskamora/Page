...
<li><a href="tipoinfo.php">Tipo Infomación</a></li>            <li><a href="tipoadmin.php">Tipo Administrador</a></li>
...
<div class="container">
   <div class="row-fluid">
	...
	<tbody>
      <?php   
	  echo '<tr>';
			echo '<td width="40%">  <label>'.$row[1].' </label></td>';			
			echo ' <td width="60%"> <label>'.$row[2].' </label></td>';			
			echo '</tr>';
		?>
    </tbody>	  
    </table>
