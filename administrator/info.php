      ...
      <?php    
		for ($i=0;$i<$registros;$i++){
			...
			if(strlen($row["descripcion"])<50){
				...
				echo '<td width="20%">'.substr($row["descripcion"],0,50)."...".'</td>';
			}
			...
			echo '<td width="15%"> <a href="eliminarinfo.php?id='.$row["informacionid"].'"> <button class="btn btn-primary"  type="button" name="boton"> <span class="add-on"><i class="icon-trash"></i> </span> Eliminar  </button>  </td></a>';
			echo '<td width="11%"> <a href="verinfo.php?id='.$row["informacionid"].'"> <button class="btn btn-primary"  type="button" name="boton"> <span class="add-on"><i class="icon-eye-open"></i> </span> Ver  </button>  </td></a>';
			echo '</tr>';
			}
		?>
	</form>
